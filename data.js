...
/* ============================================================
   ...
   ※現時点ではサンプル内容。連絡先・文言は後日オーナーが更新予定。
   ============================================================ */
const UTILITY_ITEMS = [
  {
    id: "electricity",
    ...
    steps: [
      ...
      "ブレーカーを上げても直らない場合は、契約している電力会社（四国電力ネットワークなど）にご連絡ください。",
      "自分で分からない場合は、まず管理人にご連絡ください。",
    ],
    companyNote: "✏️ ここに電力会社の連絡先を追加してください（例：四国電力ネットワーク）",
  },
  {
    id: "gas",
    emoji: "🔥",
    ...
    color: "orange",
    steps: [
      "ガスの匂いがする場合は、火や電気のスイッチを使わず、まず窓を開けて換気してください。",
      "ガスコンロが使えない場合は、ガスの元栓やガスメーターの復帰ボタンを確認してください。",
      "自分で分からない場合は、まず管理人にご連絡ください。",
    ],
    companyNote: "✏️ ここにガス会社の連絡先を追加してください（例：LPガス業者）",
  },
  {
    id: "water",
    emoji: "💧",
    ...
    color: "blue",
    steps: [
      "水が出ない場合は、水道の元栓（止水栓）が閉まっていないか確認してください。",
      "水漏れしている場合は、まず元栓を閉めてください。",
      "自分で分からない場合は、まず管理人にご連絡ください。",
    ],
    companyNote: "✏️ ここに水道局の連絡先を追加してください（例：伊予市水道課）",
  },
  {
    id: "internet",
    emoji: "📶",
    ...
    color: "pink",
    steps: [
      "スマホ・PC側のWi-Fi設定がオンになっているか確認してください。",
      "つながらない場合は、ルーターの再起動が必要な場合があります。",
      "自分で分からない場合は、まず管理人にご連絡ください。",
    ],
    companyNote: "✏️ ここにプロバイダの連絡先を追加してください",
    wifiLink: true,
  },
];
