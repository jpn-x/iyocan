...
/* ============================================================
   4.5) 🆘 設備トラブル（電気・ガス・水道・ネット）
   ※現時点ではサンプル内容。写真・動画・連絡先は後日オーナーが更新予定。
   ============================================================ */
const UTILITY_ITEMS = [
  {
    id: "electricity",
    ...
    pageTitle: "⚡ 電気がつかないとき",
    reassureText:
      "電気がつかない場合でも、まず確認する場所があります。<br/>多くの場合、ブレーカーを確認することで解決できます。",
    symptoms: ["電気がつかない", "一部の電気だけつかない", "家中の電気が消えた", "ブレーカーが落ちた", "エアコンが動かない"],
    step1: {
      title: "ブレーカーを確認",
      text: "まず、ブレーカーを確認してください。",
      photos: ["IYOCANの実際のブレーカー写真"],
    },
    step2: {
      title: "ブレーカーが下がっていたら",
      text: "下がっているブレーカーがあれば、ゆっくり上げてください。",
      videoTitle: "🎥 ブレーカーを上げる方法",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "それでも電気がつかない場合",
      text: "家全体の電気がつかない場合は、周辺地域の停電など、電力会社側の可能性があります。",
      companies: [{ name: "四国電力送配電", tel: "0120-410-503" }],
      closingNote: "わからない場合は無理に操作せず、管理人にご連絡ください。",
    },
  },
  {
    id: "gas",
    ...
    color: "orange",
    pageTitle: "🔥 ガスが使えないとき",
    reassureText: "ガスが使えない場合も、まず確認できる場所があります。<br/>LPガスを使用しています。",
    symptoms: ["ガスコンロがつかない", "お湯が出ない", "ガスの匂いがする", "ガスメーターが止まっている"],
    step1: {
      title: "ガスメーター・元栓を確認",
      photos: ["IYOCANのガスメーター写真", "ガスの元栓の写真"],
    },
    step2: {
      title: "ガスを確認",
      text: "ガスメーターや元栓について、確認できる範囲を簡単に説明します。",
      videoTitle: "🎥 ガスの確認・復旧方法",
      videoId: "dQw4w9WgXcQ",
    },
    urgent: {
      title: "🚨 ガス臭い場合",
      text:
        "ガス臭い場合は、火を使わないでください。<br/>電気のスイッチや換気扇にも触れず、窓や戸を開け、安全な場所へ移動してください。",
      companies: [{ name: "エナジー・ワン", tel: "089-952-7711", note: "緊急時：音声ガイダンス → 1" }],
    },
    step3: {
      title: "それでも解決しない場合",
      text: "わからない場合は管理人へご連絡ください。",
      companies: [],
    },
  },
  {
    ...
    title: "水道",
    color: "blue",
    pageTitle: "💧 水が出ない・水が止まらないとき",
    reassureText: "水道のトラブルが起きた場合も、まず確認できることがあります。",
    symptoms: ["水が出ない", "水の出が弱い", "水が止まらない", "水漏れしている"],
    step1: {
      title: "蛇口を確認",
      checklist: ["他の蛇口からも水が出ないか", "一部だけの問題か"],
    },
    step2: {
      title: "水漏れの場合",
      text: "水が止まらない場合は、水道の元栓を閉めることで一旦水を止めることができます。",
      photos: ["IYOCANの水道元栓の写真"],
      videoTitle: "🎥 水道の元栓を閉める方法",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "それでも解決しない場合",
      companies: [
        { name: "伊予市上下水道課（料金・使用手続き）", tel: "089-909-6387" },
        { name: "伊予市上下水道課（漏水・設備）", tel: "089-982-1130" },
      ],
      closingNote: "基本的には、まず元栓を閉めて、管理人へご連絡ください。",
    },
  },
  {
    id: "internet",
    ...
    title: "ネット",
    color: "pink",
    pageTitle: "📶 Wi-Fiにつながらないとき",
    reassureText:
      "Wi-Fiにつながらない場合は、まずルーターを再起動してみてください。<br/>多くの場合、再起動で改善します。",
    symptoms: ["Wi-Fiにつながらない", "インターネットが遅い", "接続が途切れる"],
    step1: {
      title: "Wi-Fiを確認",
      checklist: ["Wi-FiがONになっているか", "IYOCANのWi-Fiを選択しているか"],
    },
    step2: {
      title: "ルーターを再起動",
      text: "ルーターの電源を入れ直します。",
      photos: ["IYOCANのルーター写真"],
      numberedSteps: [
        "ルーターの電源コードを抜く",
        "10秒ほど待つ",
        "電源コードを差し直す",
      ...
      videoTitle: "🎥 Wi-Fiルーターを再起動する方法",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "それでもつながらない場合",
      text: "ここまで試してもつながらない場合は、ピカラ側の通信障害や通信エラーなどの可能性があります。",
      companies: [
        { name: "ピカラ", tel: "0800-100-3810" },
        { name: "ピカラ（契約・料金など）", tel: "0800-100-3950" },
      ],
      closingNote: "まずは管理人へご連絡ください。",
    },
    wifiLink: true,
  },
];
...
const STRINGS = {
  ...
  home: {
    ...
    qlPromo: "🤖 AIで本領発揮する",
    qlWifi: "📶 Wi-Fiを接続",
    houseTitle: "IYOCANの説明書",
    houseSub: "宿の情報はここを見てね",
    ehimeTitle: "愛媛を楽しむ",
  ...
  help: {
    ...
    utilityHeading: "設備のトラブル",
    utilityPageTitle: "設備トラブル",
    sampleBadge: "サンプル",
    sampleNote: "※この内容は仮のサンプルです。連絡先は追ってオーナーが設定します。",
    selfCheckTitle: "🔍 まずセルフチェック",
    companyContactTitle: "📞 連絡先",
    managerCtaNote: "自分で分からない・直らないときは、まず管理人に連絡してね",
    wifiLinkLabel: "📶 Wi-Fiの接続情報を見る",
    reassureTitle: "ご安心ください",
    reassureSub: "ほとんどのトラブルは、簡単な確認や操作で解決できます。<br/>まずは下の手順をゆっくり確認してください。",
    symptomsTitle: "こんなとき",
    photoPlaceholderLabel: "実際の写真をここに配置",
    managerCtaTitle: "わからない場合は、管理人にご連絡ください",
    telLabel: "📞 電話",
    lineLabel: "💬 LINE",
  },
