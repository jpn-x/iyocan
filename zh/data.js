...
const UTILITY_ITEMS = [
  {
    ...
    color: "yellow",
    pageTitle: "⚡ 没有电的时候",
    reassureText: "即使没有电，也有一个简单的地方可以先检查。<br/>大多数情况下，检查断路器就能解决。",
    symptoms: ["没有电", "只有部分插座没电", "整个房间都停电了", "断路器跳闸了", "空调无法运转"],
    step1: {
      title: "检查断路器",
      text: "请先检查断路器（配电箱）。",
      photos: ["IYOCAN实际的断路器照片"],
    },
    step2: {
      title: "如果断路器跳闸了",
      text: "如果发现断路器跳到关闭位置，请慢慢将它扳回打开。",
      videoTitle: "🎥 恢复断路器的方法",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "如果还是没有电",
      text: "如果整个房屋都没电，可能是周边地区停电，属于电力公司方面的问题。",
      companies: [{ name: "四国电力送配电", tel: "0120-410-503" }],
      closingNote: "如果不清楚，请不要勉强自己操作，直接联系房东。",
    },
  },
  {
    id: "gas",
    ...
    color: "orange",
    pageTitle: "🔥 燃气用不了的时候",
    reassureText: "即使燃气用不了，也有可以先检查的地方。<br/>本住宅使用的是液化石油气（LP气）。",
    symptoms: ["燃气灶点不着", "没有热水", "闻到燃气味", "燃气表看起来停止了"],
    step1: {
      title: "检查燃气表・总阀门",
      photos: ["IYOCAN的燃气表照片", "燃气总阀门的照片"],
    },
    step2: {
      title: "检查燃气",
      text: "关于燃气表和阀门，为您简单说明可以自行确认的范围。",
      videoTitle: "🎥 燃气检查・复位方法",
      videoId: "dQw4w9WgXcQ",
    },
    urgent: {
      title: "🚨 如果闻到燃气味",
      text: "如果闻到燃气味，请不要使用明火。<br/>也不要触碰电器开关或换气扇，请打开窗户或门，前往安全的地方。",
      companies: [{ name: "Energy One", tel: "089-952-7711", note: "紧急情况：语音导航→按1" }],
    },
    step3: {
      title: "如果仍未解决",
      text: "如果不清楚，请联系房东。",
  ...
  },
  {
    ...
    title: "自来水",
    color: "blue",
    pageTitle: "💧 没有水・水关不住的时候",
    reassureText: "即使发生自来水的问题，也有可以先检查的地方。",
    symptoms: ["没有水流出", "水流很弱", "水关不住", "发生漏水"],
    step1: {
      title: "检查水龙头",
      checklist: ["其他水龙头是否也没有水", "是否只是某一处的问题"],
    },
    step2: {
      title: "漏水的情况",
      text: "如果水关不住，关闭总阀门可以暂时止水。",
      photos: ["IYOCAN自来水总阀门的照片"],
      videoTitle: "🎥 关闭自来水总阀门的方法",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "如果仍未解决",
      companies: [
        { name: "伊予市上下水道课（费用・手续）", tel: "089-909-6387" },
        { name: "伊予市上下水道课（漏水・设备）", tel: "089-982-1130" },
      ],
      closingNote: "基本上，请先关闭总阀门，再联系房东。",
    },
  },
  {
    id: "internet",
    ...
    title: "网络",
    color: "pink",
    pageTitle: "📶 Wi-Fi连不上的时候",
    reassureText: "如果Wi-Fi连不上，请先尝试重启路由器。<br/>大多数情况下，重启就能改善。",
    symptoms: ["Wi-Fi连不上", "网速很慢", "连接经常中断"],
    step1: {
      title: "检查Wi-Fi设置",
      checklist: ["Wi-Fi是否已打开", "是否选择了IYOCAN的Wi-Fi网络"],
    },
    step2: {
      title: "重启路由器",
      text: "为您说明如何重新启动路由器。",
      photos: ["IYOCAN的Wi-Fi路由器照片"],
      numberedSteps: ["拔掉路由器的电源线", "等待约10秒", "重新插上电源线", "等待几分钟", "再次尝试连接Wi-Fi"],
      videoTitle: "🎥 重启Wi-Fi路由器的方法",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "如果仍然连不上",
      text: "如果尝试以上方法后仍连不上，可能是Pikara（当地网络运营商）方面发生了通信故障或线路问题。",
      companies: [
        { name: "Pikara", tel: "0800-100-3810" },
        { name: "Pikara（合约・费用等）", tel: "0800-100-3950" },
      ],
      closingNote: "请先联系房东。",
    },
    wifiLink: true,
...
const STRINGS = {
  ...
  help: {
    ...
    emergencyPolice: "警察",
    utilityHeading: "设备故障",
    utilityPageTitle: "设备故障",
    sampleBadge: "示例",
    sampleNote: "此内容为暂定示例，房东会之后补充真实联系方式。",
    selfCheckTitle: "🔍 先自行检查",
    companyContactTitle: "📞 联系方式",
    managerCtaNote: "如果自己无法判断或仍未解决，请先联系房东",
    wifiLinkLabel: "📶 查看Wi-Fi连接信息",
    reassureTitle: "请放心",
    reassureSub: "大部分问题只需简单确认或操作即可解决。<br/>请慢慢按照下面的步骤检查。",
    symptomsTitle: "遇到这些情况",
    photoPlaceholderLabel: "实际照片将放置于此",
    managerCtaTitle: "如果不清楚，请联系房东",
    telLabel: "📞 电话",
    lineLabel: "💬 LINE",
  },
