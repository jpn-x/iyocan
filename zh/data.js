...
const UTILITY_ITEMS = [
  {
    ...
    steps: [
      "请先确认是否是断路器（漏电开关）跳闸了。",
      "如果重新合上断路器仍无法解决，请联系电力公司（例如四国电力）。",
      "如果自己无法判断，请先联系房东。",
    ],
    companyNote: "✏️ 请在此处填写电力公司的联系方式（例如四国电力）",
  },
  {
    id: "gas",
    emoji: "🔥",
    ...
    color: "orange",
    steps: [
      "如果闻到燃气味，请不要使用明火或电器开关，先打开窗户通风。",
      "如果燃气灶用不了，请检查燃气阀门和燃气表的复位按钮。",
      "如果自己无法判断，请先联系房东。",
    ],
    companyNote: "✏️ 请在此处填写燃气公司的联系方式（例如液化气供应商）",
  },
  {
    id: "water",
    emoji: "💧",
    ...
    companyNote: "✏️ 请在此处填写自来水公司的联系方式（例如伊予市水务局）",
  },
  {
    id: "internet",
    emoji: "📶",
    ...
    color: "pink",
    steps: [
      "请先确认手机・电脑的Wi-Fi设置是否已打开。",
      "如果还是连不上，可能需要重启路由器。",
      "如果自己无法判断，请先联系房东。",
    ],
    companyNote: "✏️ 请在此处填写网络服务商的联系方式",
    wifiLink: true,
  },
];
