...
const UTILITY_ITEMS = [
  {
    ...
    title: "Electricity",
    color: "yellow",
    pageTitle: "⚡ When the power won't turn on",
    reassureText:
      "Even if the power's out, there's a simple place to check first.<br/>In most cases, checking the breaker solves it.",
    symptoms: ["The power won't turn on", "Only some outlets don't work", "The whole house went dark", "A breaker tripped", "The air conditioner won't run"],
    step1: {
      title: "Check the breaker",
      text: "First, please check the breaker panel.",
      photos: ["Actual photo of IYOCAN's breaker panel"],
    },
    step2: {
      title: "If a breaker has tripped",
      text: "If you find a breaker switched down, gently flip it back up.",
      videoTitle: "🎥 How to reset the breaker",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "If the power still won't come on",
      text: "If the whole house has no power, it may be a local outage on the power company's side.",
      companies: [{ name: "Shikoku Electric Power Transmission & Distribution", tel: "0120-410-503" }],
      closingNote: "If you're not sure, please don't force anything — just contact the host.",
    },
  },
  {
    id: "gas",
    ...
    title: "Gas",
    color: "orange",
    pageTitle: "🔥 When the gas isn't working",
    reassureText: "Even if the gas isn't working, there's a simple place to check first.<br/>This property uses LP (propane) gas.",
    symptoms: ["The gas stove won't light", "No hot water", "You smell gas", "The gas meter looks stopped"],
    step1: {
      title: "Check the gas meter and main valve",
      photos: ["Photo of IYOCAN's gas meter", "Photo of the gas main valve"],
    },
    step2: {
      title: "Checking the gas",
      text: "Here's a simple guide to what you can check on the meter and valve yourself.",
      videoTitle: "🎥 How to check and reset the gas",
      videoId: "dQw4w9WgXcQ",
    },
    urgent: {
      title: "🚨 If you smell gas",
      text:
        "If you smell gas, do not use any flame.<br/>Don't touch electrical switches or the ventilation fan either — open a window or door and move to a safe place.",
      companies: [{ name: "Energy One", tel: "089-952-7711", note: "In an emergency: voice menu → press 1" }],
    },
    step3: {
      title: "If it's still not resolved",
      text: "If you're not sure, please contact the host.",
      companies: [],
    },
  },
  {
    ...
    title: "Water",
    color: "blue",
    pageTitle: "💧 No water, or water that won't stop",
    reassureText: "Even with a water issue, there are simple things you can check first.",
    symptoms: ["No water comes out", "Water pressure is weak", "Water won't stop running", "There's a leak"],
    step1: {
      title: "Check the faucets",
      checklist: ["Whether other faucets also have no water", "Whether it's just one fixture"],
    },
    step2: {
      title: "If there's a leak",
      text: "If the water won't stop, closing the main shut-off valve will stop it for now.",
      photos: ["Photo of IYOCAN's main water valve"],
      videoTitle: "🎥 How to close the main water valve",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "If it's still not resolved",
      companies: [
        { name: "Iyo City Water & Sewer Dept. (billing / account)", tel: "089-909-6387" },
        { name: "Iyo City Water & Sewer Dept. (leaks / equipment)", tel: "089-982-1130" },
      ],
      closingNote: "As a first step, close the main valve and contact the host.",
    },
  },
  {
    id: "internet",
    ...
    title: "Internet",
    color: "pink",
    pageTitle: "📶 When Wi-Fi won't connect",
    reassureText:
      "If Wi-Fi won't connect, try restarting the router first.<br/>In most cases, a restart fixes it.",
    symptoms: ["Wi-Fi won't connect", "The internet is slow", "The connection keeps dropping"],
    step1: {
      title: "Check your Wi-Fi settings",
      checklist: ["Whether Wi-Fi is turned on", "Whether you've selected IYOCAN's Wi-Fi network"],
    },
    step2: {
      title: "Restart the router",
      text: "Here's how to power-cycle the router.",
      photos: ["Photo of IYOCAN's Wi-Fi router"],
      numberedSteps: [
      ...
      videoTitle: "🎥 How to restart the Wi-Fi router",
      videoId: "dQw4w9WgXcQ",
    },
    step3: {
      title: "If it still won't connect",
      text: "If it still won't connect after all this, it may be a service outage or connection issue on Pikara's side.",
      companies: [
        { name: "Pikara", tel: "0800-100-3810" },
        { name: "Pikara (plans / billing)", tel: "0800-100-3950" },
      ],
      closingNote: "Please contact the host first.",
    },
    wifiLink: true,
  },
];
...
const STRINGS = {
  ...
  help: {
    ...
    reassureTitle: "No need to worry",
    reassureSub: "Most issues can be solved with a quick check or two.<br/>Just work through the steps below at your own pace.",
    symptomsTitle: "This might be you if…",
    photoPlaceholderLabel: "Actual photo goes here",
    managerCtaTitle: "Not sure? Just contact the host",
    telLabel: "📞 Call",
    lineLabel: "💬 LINE",
  },
