...
const UTILITY_ITEMS = [
  {
    ...
    color: "yellow",
    steps: [
      "먼저 차단기가 내려가 있지 않은지 확인해 주세요.",
      "차단기를 올려도 해결되지 않으면 전력회사(예: 시코쿠전력)에 연락해 주세요.",
      "잘 모르시겠다면 먼저 호스트에게 연락해 주세요.",
    ],
    companyNote: "✏️ 전력회사 연락처를 여기에 추가해 주세요",
  },
  {
    id: "gas",
    emoji: "🔥",
    title: "가스",
    sub: "가스가 안 나옴・가스 냄새가 날 때",
    color: "orange",
    steps: [
      "가스 냄새가 난다면 불이나 전기 스위치를 사용하지 말고 먼저 창문을 열어 환기해 주세요.",
      "가스레인지가 작동하지 않으면 가스 밸브와 계량기의 복구 버튼을 확인해 주세요.",
      "잘 모르시겠다면 먼저 호스트에게 연락해 주세요.",
    ],
    companyNote: "✏️ 가스회사 연락처를 여기에 추가해 주세요",
  },
  {
    id: "water",
    emoji: "💧",
    ...
    color: "blue",
    steps: [
      "물이 안 나오면 메인 밸브가 잠겨 있지 않은지 확인해 주세요.",
      "누수가 있다면 먼저 메인 밸브를 잠가 주세요.",
      "잘 모르시겠다면 먼저 호스트에게 연락해 주세요.",
    ],
    companyNote: "✏️ 수도국 연락처를 여기에 추가해 주세요",
  },
  {
    id: "internet",
    emoji: "📶",
    title: "인터넷",
    sub: "Wi-Fi가 연결되지 않을 때",
    color: "pink",
    steps: [
      "먼저 휴대폰・PC의 Wi-Fi 설정이 켜져 있는지 확인해 주세요.",
      "그래도 연결되지 않으면 라우터 재시작이 필요할 수 있습니다.",
      "잘 모르시겠다면 먼저 호스트에게 연락해 주세요.",
    ],
    companyNote: "✏️ 인터넷 제공업체 연락처를 여기에 추가해 주세요",
    wifiLink: true,
  },
];
